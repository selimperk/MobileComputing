...
class DataStore(context: Context) {
    ...
    companion object {
        ...
        val AVATAR_KEY = intPreferencesKey("avatar_id")
    }
    ...
    // Avatar speichern
    val AVATAR_KEY = intPreferencesKey("avatar_id")
    val avatarIdFlow: Flow<Int> = dataStore.data.map { it[AVATAR_KEY] ?: R.drawable.avatar1 }

    suspend fun setAvatarId(id: Int) {
        dataStore.edit { it[AVATAR_KEY] = id }
    }
